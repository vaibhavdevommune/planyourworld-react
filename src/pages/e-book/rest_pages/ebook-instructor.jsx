...
const EBookInstructor = () => {
  const [title] = useState("E-Book Instructor");
  ...
  return (
    <section className="ebookInstructor">
      <Container>
        <div className="page-card">
          ...
          <Row className="align-items-center my-3">
            <Col sm={3}><label className="text-color">Sub Title</label></Col>
            <Col sm={9}>
              <input
                type="text"
...
export default EBookInstructor;
